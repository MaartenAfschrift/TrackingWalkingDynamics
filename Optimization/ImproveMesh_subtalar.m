function [] = ImproveMesh_subtalar(S,MPI_path,InName,varargin)
...
ContinuousFunction='Continuous_CtStiff_subtalar';      % default continuous function
...
if Ncontrols~=Nstates/2+15+6      % Add damping at joints       // does this work for model with subtalar joint ?
    ...
    ID_guess=[T_cpp_L_int(:,7:15) T_cpp_R_int(:,7:12)];
    Damping_guess=[U_L_Xcppint(:,7:15) U_R_Xcppint(:,7:12)].*damping;
