function phaseout = musdynContinous_FtildeState_GM_damped(input)
...
[Hilldiff,F] = ForceEquilibrium_FtildeState_damped(a,Ftilde,dFtilde,splinestruct.LMT,splinestruct.VMT,...
    params,input.auxdata.Fvparam,input.auxdata.Fpparam,input.auxdata.Faparam,input.auxdata.Atendon,input.auxdata.damping);
