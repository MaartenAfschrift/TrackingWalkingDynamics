...
function [err, FT] = ForceEquilibrium_FtildeState_damped(a,fse,dfse,lMT,vMT,params,Fvparam,Fpparam,Faparam,Atendon,damping)
...
% Muscle force
FM = FMo.*(Fce+Fpe+damping.*vMtilde);        % binnen haakjes ? & norm ?
