function [] = MuscleFunctions_Right_subtalar(S)
...
d=load(fullfile(RightMusclePath,'MuscleInfo_.mat'));
e=load(fullfile(RightMusclePath,'muscle_spanning_joint_INFO.mat'));
