function [] = MuscleFunctions_Left(S)
%UNTITLED Summary of this function goes here
%   Detailed explanation goes here



LeftMusclePath = fullfile(S.OutPath,'Left');

%% Load all the information
d=load(fullfile(S.OutPath,'Left','MuscleInfo_.mat'));
e=load(fullfile(S.OutPath,'Left','muscle_spanning_joint_INFO.mat'));
...
f = matlabFunction(mat(:),'File',fullfile(LeftMusclePath,'Get_Mat_Left0.m'));
